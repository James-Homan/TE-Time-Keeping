# Made by Zachary Mangiafesto & James Homan
# pip install tk 
...
tk.Button(action_button_frame, text="Start Logging", font=("Arial", 12), bg="green", fg="white", command=start_logging).grid(row=0, column=0, padx=5)
tk.Button(action_button_frame, text="Stop Logging", font=("Arial", 12), bg="orange", fg="white", command=stop_logging).grid(row=0, column=1, padx=5)
